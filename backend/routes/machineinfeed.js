...
app.post("/missioninfeed", (req, res) => {
...
app.get("/exportExcel", (req, res) => {
  ...
  db.query(sql, (error, results) => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet("MissionInfeed");
      ...
      res.setHeader(
        "Content-Disposition",
        "attachment; filename=MissionInfeed.xlsx"
      );
...
app.get("/statusCounts", (req, res) => {
  const statusCountsQuery ="SELECT Status,COUNT(Status) AS count FROM missioninfeed GROUP BY Status";
